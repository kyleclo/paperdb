...
index_query_output_list=(
    ...
    "data/index-para-abs-v2 data/synth/content_as_query/train_claude_key_passages.jsonl results/content_as_query-claude_key_passages/train.dense-para-abs.results.jsonl"

    # /mmfs1/home/chentong/ws/cse544/project/paperdb/data/synth/content_as_query/train_claude_keywords.jsonl
    "data/index-all-units-v2 data/synth/content_as_query/train_claude_keywords.jsonl results/content_as_query-claude_keywords/train.dense-all-units.results.jsonl"
    "data/index-para-abs-v2 data/synth/content_as_query/train_claude_keywords.jsonl results/content_as_query-claude_keywords/train.dense-para-abs.results.jsonl"

    # /mmfs1/home/chentong/ws/cse544/project/paperdb/data/synth/content_as_query/train_gpt_key_passages.jsonl
    "data/index-all-units-v2 data/synth/content_as_query/train_gpt_key_passages.jsonl results/content_as_query-gpt_key_passages/train.dense-all-units.results.jsonl"
    "data/index-para-abs-v2 data/synth/content_as_query/train_gpt_key_passages.jsonl results/content_as_query-gpt_key_passages/train.dense-para-abs.results.jsonl"

    # /mmfs1/home/chentong/ws/cse544/project/paperdb/data/synth/content_as_query/train_gpt_keywords.jsonl
    "data/index-all-units-v2 data/synth/content_as_query/train_gpt_keywords.jsonl results/content_as_query-gpt_keywords/train.dense-all-units.results.jsonl"
    "data/index-para-abs-v2 data/synth/content_as_query/train_gpt_keywords.jsonl results/content_as_query-gpt_keywords/train.dense-para-abs.results.jsonl"
)
...
for args in "${index_query_output_list[@]}"; do
    ...
    python $PROJECT_ROOT/db/retrieve_dense_v2.py \
