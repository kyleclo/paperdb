...
index_query_output_list=(
    ...
    "data/index-para-abs-v2 data/synth/content_as_query/train_gpt_key_passages.jsonl results/content_as_query_gpt_key_passages/train.dense.para-abs.results.jsonl"
    "data/index-para-abs-v2 data/synth/content_as_query/train_gpt_keywords.jsonl results/content_as_query_gpt_keywords/train.dense.para-abs.results.jsonl"
)
