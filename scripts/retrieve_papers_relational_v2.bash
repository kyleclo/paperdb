...
style_query_output_list=(
    ...
    "gpt-5.1 minimal data/synth/content_as_query/train_gpt_key_passages.jsonl results/content_as_query_gpt_key_passages/train.relational.gpt-51.minimal.results.jsonl"
    "gpt-5.1 minimal data/synth/content_as_query/train_gpt_keywords.jsonl results/content_as_query-gpt_keywords/train.relational.gpt-51.minimal.results.jsonl"
)
